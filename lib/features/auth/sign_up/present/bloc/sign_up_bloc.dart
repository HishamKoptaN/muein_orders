...
class SignUpBloc extends Bloc<SignUpEvent, SignUpState> {
      ...
      (event, emit) async {
        await event.when(
          ...
          updateData: (
            ...
            _firstViewFormzSubmissionStatus = Formz.validate([
            ...
            _opportunityLookingformzSubmissionStatus = Formz.validate([
              _name ?? const GenericFormzInput.pure(),
  ...
  void emitCustomLoaded({required Emitter<SignUpState> emit}) {
    return emit(
      SignUpState.loaded(
