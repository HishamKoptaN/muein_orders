...
@override
String toString() {
  return 'CachedDoc(id: $id, orderId: $orderId, imageOne: $imageOne, imageTwo: $imageTwo, videoOne: $videoOne, videoTwo: $videoTwo, latitude: $latitude, longitude: $longitude, shippingCost: $shippingCost, uploadStatus: $uploadStatus, uploadProgress: $uploadProgress)';
}
...
/// @nodoc
abstract mixin class $CachedDocCopyWith<$Res>  {
  factory $CachedDocCopyWith(CachedDoc value, $Res Function(CachedDoc) _then) = _$CachedDocCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$CachedDocCopyWithImpl<$Res>
    implements $CachedDocCopyWith<$Res> {
  _$CachedDocCopyWithImpl(this._self, this._then);

  final CachedDoc _self;
  final $Res Function(CachedDoc) _then;
...
/// Adds pattern-matching-related methods to [CachedDoc].
extension CachedDocPatterns on CachedDoc {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _CachedDoc value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _CachedDoc() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _CachedDoc value)  $default,){
final _that = this;
switch (_that) {
case _CachedDoc():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _CachedDoc value)?  $default,){
final _that = this;
switch (_that) {
case _CachedDoc() when $default != null:
return $default(_that);case _:
...
class _CachedDoc implements CachedDoc {
  const _CachedDoc({this.id, this.orderId, this.imageOne, this.imageTwo, this.videoOne, this.videoTwo, this.latitude, this.longitude, this.shippingCost, this.uploadStatus = UploadStatus.pending, this.uploadProgress = 0.0});
  factory _CachedDoc.fromJson(Map<String, dynamic> json) => _$CachedDocFromJson(json);
...
@override
Map<String, dynamic> toJson() {
  return _$CachedDocToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CachedDoc&&(identical(other.id, id) || other.id == id)&&(identical(other.orderId, orderId) || other.orderId == orderId)&&(identical(other.imageOne, imageOne) || other.imageOne == imageOne)&&(identical(other.imageTwo, imageTwo) || other.imageTwo == imageTwo)&&(identical(other.videoOne, videoOne) || other.videoOne == videoOne)&&(identical(other.videoTwo, videoTwo) || other.videoTwo == videoTwo)&&(identical(other.latitude, latitude) || other.latitude == latitude)&&(identical(other.longitude, longitude) || other.longitude == longitude)&&(identical(other.shippingCost, shippingCost) || other.shippingCost == shippingCost)&&(identical(other.uploadStatus, uploadStatus) || other.uploadStatus == uploadStatus)&&(identical(other.uploadProgress, uploadProgress) || other.uploadProgress == uploadProgress));
}
...
/// @nodoc
abstract mixin class _$CachedDocCopyWith<$Res> implements $CachedDocCopyWith<$Res> {
