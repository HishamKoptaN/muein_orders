...
class $CachedDocsTable extends CachedDocs
  ...
  static const VerificationMeta _imageOneMeta =
      const VerificationMeta('imageOne');
  @override
  late final GeneratedColumn<String> imageOne = GeneratedColumn<String>(
      'image_one', aliasedName, true,
      type: DriftSqlType.string, requiredDuringInsert: false);
  static const VerificationMeta _imageTwoMeta =
      const VerificationMeta('imageTwo');
  @override
  late final GeneratedColumn<String> imageTwo = GeneratedColumn<String>(
      'image_two', aliasedName, true,
      type: DriftSqlType.string, requiredDuringInsert: false);
  static const VerificationMeta _videoOneMeta =
      const VerificationMeta('videoOne');
  @override
  late final GeneratedColumn<String> videoOne = GeneratedColumn<String>(
      'video_one', aliasedName, true,
      type: DriftSqlType.string, requiredDuringInsert: false);
  static const VerificationMeta _videoTwoMeta =
      const VerificationMeta('videoTwo');
  @override
  late final GeneratedColumn<String> videoTwo = GeneratedColumn<String>(
      'video_two', aliasedName, true,
      type: DriftSqlType.string, requiredDuringInsert: false);
  ...
  late final GeneratedColumn<double> shippingCost = GeneratedColumn<double>(
      'shipping_cost', aliasedName, true,
      type: DriftSqlType.double, requiredDuringInsert: false);
  ...
  @override
  VerificationContext validateIntegrity(Insertable<CachedDoc> instance,
  ...
  CachedDoc map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return CachedDoc(
      ...
      imageOne: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}image_one']),
      imageTwo: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}image_two']),
      videoOne: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}video_one']),
      videoTwo: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}video_two']),
...
class CachedDoc extends DataClass implements Insertable<CachedDoc> {
  ...
  CachedDoc copyWith(
      ...
      CachedDoc(
        ...
        shippingCost:
            shippingCost.present ? shippingCost.value : this.shippingCost,
...
typedef $$CachedDocsTableCreateCompanionBuilder = CachedDocsCompanion Function({
  Value<int> id,
  required int orderId,
  Value<String?> imageOne,
  Value<String?> imageTwo,
...
typedef $$CachedDocsTableUpdateCompanionBuilder = CachedDocsCompanion Function({
  Value<int> id,
  Value<int> orderId,
  Value<String?> imageOne,
  Value<String?> imageTwo,
...
class $$CachedDocsTableFilterComposer
  ...
  ColumnFilters<String> get imageOne => $composableBuilder(
      column: $table.imageOne, builder: (column) => ColumnFilters(column));

  ColumnFilters<String> get imageTwo => $composableBuilder(
      column: $table.imageTwo, builder: (column) => ColumnFilters(column));

  ColumnFilters<String> get videoOne => $composableBuilder(
      column: $table.videoOne, builder: (column) => ColumnFilters(column));

  ColumnFilters<String> get videoTwo => $composableBuilder(
      column: $table.videoTwo, builder: (column) => ColumnFilters(column));
...
class $$CachedDocsTableOrderingComposer
  ...
  ColumnOrderings<String> get imageOne => $composableBuilder(
      column: $table.imageOne, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<String> get imageTwo => $composableBuilder(
      column: $table.imageTwo, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<String> get videoOne => $composableBuilder(
      column: $table.videoOne, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<String> get videoTwo => $composableBuilder(
      column: $table.videoTwo, builder: (column) => ColumnOrderings(column));
...
class $$CachedDocsTableTableManager extends RootTableManager<
    _$AppDatabase,
    $CachedDocsTable,
    CachedDoc,
    $$CachedDocsTableFilterComposer,
...
typedef $$CachedDocsTableProcessedTableManager = ProcessedTableManager<
    _$AppDatabase,
    $CachedDocsTable,
    CachedDoc,
    $$CachedDocsTableFilterComposer,
