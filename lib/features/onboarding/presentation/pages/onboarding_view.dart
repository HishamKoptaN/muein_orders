            ...
            if (state is OnboardingError) {
              return Center(
                child: Column(
                  ...
                  children: [
                    Text('حدث خطأ أثناء تحميل شاشات التعريف'),
                    const SizedBox(height: 16),
                    ElevatedButton(
                      onPressed: () => context.read<OnboardingBloc>().add(CheckOnboardingStatus()),
                ...
                children: [
                  ...
                  Positioned(
                    ...
                    child: ElevatedButton(
                      ...
                      child: Text(
                        _currentPageIndex == state.pages.length - 1 ? 'ابدأ الآن' : 'التالي',
