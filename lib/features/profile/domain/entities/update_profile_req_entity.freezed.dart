...
class _$UpdateProfileReqEntityImpl implements _UpdateProfileReqEntity {
  const _$UpdateProfileReqEntityImpl({this.name, this.phone});
  ...
  @override
  String toString() {
    return 'UpdateProfileReqEntity(name: $name, phone: $phone)';
  }
...
abstract class _UpdateProfileReqEntity implements UpdateProfileReqEntity {
  const factory _UpdateProfileReqEntity(
      {final String? name, final String? phone}) = _$UpdateProfileReqEntityImpl;
