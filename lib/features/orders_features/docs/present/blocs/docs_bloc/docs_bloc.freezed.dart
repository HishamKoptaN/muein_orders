...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  loading,TResult Function()?  success,TResult Function( List<SallaOrderItemUnitEntity>? docs,  bool? hasMore)?  loaded,TResult Function( ErrorInfo apiErrorModel)?  failure,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LoadInProgress() when loading != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  loading,required TResult Function()  success,required TResult Function( List<SallaOrderItemUnitEntity>? docs,  bool? hasMore)  loaded,required TResult Function( ErrorInfo apiErrorModel)  failure,}) {final _that = this;
switch (_that) {
case _LoadInProgress():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  loading,TResult? Function()?  success,TResult? Function( List<SallaOrderItemUnitEntity>? docs,  bool? hasMore)?  loaded,TResult? Function( ErrorInfo apiErrorModel)?  failure,}) {final _that = this;
switch (_that) {
case _LoadInProgress() when loading != null:
return loading();case _Success() when success != null:
return success();case _Loaded() when loaded != null:
...
@JsonKey() List<SallaOrderItemUnitEntity>? get docs {
  final value = _docs;
...
@useResult
$Res call({
 List<SallaOrderItemUnitEntity>? docs, bool? hasMore
});
...
as List<SallaOrderItemUnitEntity>?,hasMore: freezed == hasMore ? _self.hasMore : hasMore // ignore: cast_nullable_to_non_nullable
as bool?,
  ));
}
