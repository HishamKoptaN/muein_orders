...
class OrdersRepoImpl implements OrdersRepo {
  ...
  // ) {
  //   final mergedOrders = ordersRes.orders.map((order) {
  ...
  //   }).toList();
  //   return OrdersResEntity(orders: mergedOrders, meta: MetaEntity());
  // }
  ...
  //   final filtered = ordersRes.orders.where((order) {
  //     return order.matchesStatus(fileUploadStatus: filter);
  //   }).toList();

  //   return OrdersResEntity(orders: filtered, meta: const MetaEntity());
  // }
}
