...
@JsonKey(name: 'data') List<SallaOrderItemModel>? get items;@JsonKey(name: 'meta') MetaModel? get meta;
...
void debugFillProperties(DiagnosticPropertiesBuilder properties) {
  properties
    ...
    ..add(DiagnosticsProperty('items', items))..add(DiagnosticsProperty('meta', meta));
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SallaOrderItemsResModel&&const DeepCollectionEquality().equals(other.items, items)&&(identical(other.meta, meta) || other.meta == meta));
}
...
String toString({ DiagnosticLevel minLevel = DiagnosticLevel.info }) {
  return 'SallaOrderItemsResModel(items: $items, meta: $meta)';
}
...
@useResult
$Res call({
@JsonKey(name: 'data') List<SallaOrderItemModel>? items,@JsonKey(name: 'meta') MetaModel? meta
});
...
as List<SallaOrderItemModel>?,meta: freezed == meta ? _self.meta : meta // ignore: cast_nullable_to_non_nullable
as MetaModel?,
  ));
}
/// Create a copy of SallaOrderItemsResModel
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'data')  List<SallaOrderItemModel>? items, @JsonKey(name: 'meta')  MetaModel? meta)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SallaOrderItemsResModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'data')  List<SallaOrderItemModel>? items, @JsonKey(name: 'meta')  MetaModel? meta)  $default,) {final _that = this;
switch (_that) {
case _SallaOrderItemsResModel():
return $default(_that.items,_that.meta);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'data')  List<SallaOrderItemModel>? items, @JsonKey(name: 'meta')  MetaModel? meta)?  $default,) {final _that = this;
switch (_that) {
case _SallaOrderItemsResModel() when $default != null:
return $default(_that.items,_that.meta);case _:
  return null;
...
class _SallaOrderItemsResModel with DiagnosticableTreeMixin implements SallaOrderItemsResModel {
  const _SallaOrderItemsResModel({@JsonKey(name: 'data') final  List<SallaOrderItemModel>? items, @JsonKey(name: 'meta') this.meta}): _items = items;
  factory _SallaOrderItemsResModel.fromJson(Map<String, dynamic> json) => _$SallaOrderItemsResModelFromJson(json);

 final  List<SallaOrderItemModel>? _items;
@override@JsonKey(name: 'data') List<SallaOrderItemModel>? get items {
  final value = _items;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SallaOrderItemsResModel&&const DeepCollectionEquality().equals(other._items, _items)&&(identical(other.meta, meta) || other.meta == meta));
}
...
@JsonKey(name: 'id') int? get id;@JsonKey(name: 'printed_name') String? get printedName;@JsonKey(name: 'salla_order_item_units') List<SallaOrderItemUnitModel>? get sallaOrderItemUnits;@JsonKey(name: 'created_at') String? get created_at;@JsonKey(name: 'updated_at') String? get updated_at;
...
void debugFillProperties(DiagnosticPropertiesBuilder properties) {
  properties
    ...
    ..add(DiagnosticsProperty('id', id))..add(DiagnosticsProperty('printedName', printedName))..add(DiagnosticsProperty('sallaOrderItemUnits', sallaOrderItemUnits))..add(DiagnosticsProperty('created_at', created_at))..add(DiagnosticsProperty('updated_at', updated_at));
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,printedName,const DeepCollectionEquality().hash(sallaOrderItemUnits),created_at,updated_at);

@override
String toString({ DiagnosticLevel minLevel = DiagnosticLevel.info }) {
  return 'SallaOrderItemModel(id: $id, printedName: $printedName, sallaOrderItemUnits: $sallaOrderItemUnits, created_at: $created_at, updated_at: $updated_at)';
}
...
@useResult
$Res call({
@JsonKey(name: 'id') int? id,@JsonKey(name: 'printed_name') String? printedName,@JsonKey(name: 'salla_order_item_units') List<SallaOrderItemUnitModel>? sallaOrderItemUnits,@JsonKey(name: 'created_at') String? created_at,@JsonKey(name: 'updated_at') String? updated_at
});
...
/// Create a copy of SallaOrderItemModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? printedName = freezed,Object? sallaOrderItemUnits = freezed,Object? created_at = freezed,Object? updated_at = freezed,}) {
  return _then(_self.copyWith(
id: freezed == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as int?,printedName: freezed == printedName ? _self.printedName : printedName // ignore: cast_nullable_to_non_nullable
as String?,sallaOrderItemUnits: freezed == sallaOrderItemUnits ? _self.sallaOrderItemUnits : sallaOrderItemUnits // ignore: cast_nullable_to_non_nullable
as List<SallaOrderItemUnitModel>?,created_at: freezed == created_at ? _self.created_at : created_at // ignore: cast_nullable_to_non_nullable
...
class _SallaOrderItemModel with DiagnosticableTreeMixin implements SallaOrderItemModel {
  const _SallaOrderItemModel({@JsonKey(name: 'id') this.id, @JsonKey(name: 'printed_name') this.printedName, @JsonKey(name: 'salla_order_item_units') final  List<SallaOrderItemUnitModel>? sallaOrderItemUnits, @JsonKey(name: 'created_at') this.created_at, @JsonKey(name: 'updated_at') this.updated_at}): _sallaOrderItemUnits = sallaOrderItemUnits;
...
@override@JsonKey(name: 'salla_order_item_units') List<SallaOrderItemUnitModel>? get sallaOrderItemUnits {
  final value = _sallaOrderItemUnits;
  if (value == null) return null;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,printedName,const DeepCollectionEquality().hash(_sallaOrderItemUnits),created_at,updated_at);
...
/// Create a copy of SallaOrderItemModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? printedName = freezed,Object? sallaOrderItemUnits = freezed,Object? created_at = freezed,Object? updated_at = freezed,}) {
  return _then(_SallaOrderItemModel(
id: freezed == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as int?,printedName: freezed == printedName ? _self.printedName : printedName // ignore: cast_nullable_to_non_nullable
as String?,sallaOrderItemUnits: freezed == sallaOrderItemUnits ? _self._sallaOrderItemUnits : sallaOrderItemUnits // ignore: cast_nullable_to_non_nullable
as List<SallaOrderItemUnitModel>?,created_at: freezed == created_at ? _self.created_at : created_at // ignore: cast_nullable_to_non_nullable
as String?,updated_at: freezed == updated_at ? _self.updated_at : updated_at // ignore: cast_nullable_to_non_nullable
as String?,
  ));
...
mixin _$SallaOrderItemUnitModel implements DiagnosticableTreeMixin {
 ...
 int get id;@JsonKey(name: 'unit_number') int get unitNumber;@JsonKey(name: 'execution_number') String get executionNumber;@JsonKey(name: 'documentations') List<DocModel> get docs;@JsonKey(name: 'created_at') String get createdAt;@JsonKey(name: 'updated_at') String get updatedAt;
...
@useResult
$Res call({
 int id,@JsonKey(name: 'unit_number') int unitNumber,@JsonKey(name: 'execution_number') String executionNumber,@JsonKey(name: 'documentations') List<DocModel> docs,@JsonKey(name: 'created_at') String createdAt,@JsonKey(name: 'updated_at') String updatedAt
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id, @JsonKey(name: 'unit_number')  int unitNumber, @JsonKey(name: 'execution_number')  String executionNumber, @JsonKey(name: 'documentations')  List<DocModel> docs, @JsonKey(name: 'created_at')  String createdAt, @JsonKey(name: 'updated_at')  String updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SallaOrderItemUnitModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id, @JsonKey(name: 'unit_number')  int unitNumber, @JsonKey(name: 'execution_number')  String executionNumber, @JsonKey(name: 'documentations')  List<DocModel> docs, @JsonKey(name: 'created_at')  String createdAt, @JsonKey(name: 'updated_at')  String updatedAt)  $default,) {final _that = this;
switch (_that) {
case _SallaOrderItemUnitModel():
return $default(_that.id,_that.unitNumber,_that.executionNumber,_that.docs,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id, @JsonKey(name: 'unit_number')  int unitNumber, @JsonKey(name: 'execution_number')  String executionNumber, @JsonKey(name: 'documentations')  List<DocModel> docs, @JsonKey(name: 'created_at')  String createdAt, @JsonKey(name: 'updated_at')  String updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _SallaOrderItemUnitModel() when $default != null:
return $default(_that.id,_that.unitNumber,_that.executionNumber,_that.docs,_that.createdAt,_that.updatedAt);case _:
  return null;
...
class _SallaOrderItemUnitModel with DiagnosticableTreeMixin implements SallaOrderItemUnitModel {
  const _SallaOrderItemUnitModel({this.id = 0, @JsonKey(name: 'unit_number') this.unitNumber = 0, @JsonKey(name: 'execution_number') this.executionNumber = '', @JsonKey(name: 'documentations') final  List<DocModel> docs = const [], @JsonKey(name: 'created_at') this.createdAt = '', @JsonKey(name: 'updated_at') this.updatedAt = ''}): _docs = docs;
