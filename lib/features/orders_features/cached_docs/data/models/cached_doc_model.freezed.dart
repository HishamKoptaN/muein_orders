...
@override
String toString() {
  return 'CachedDocModel(docId: $docId, files: $files, location: $location, uploadStatus: $uploadStatus, uploadProgress: $uploadProgress)';
}
...
class _CachedDocModel implements CachedDocModel {
  const _CachedDocModel({this.docId, final  List<DocFile>? files, this.location, this.uploadStatus = FileUploadStatus.pending, this.uploadProgress = 0.0}): _files = files;
