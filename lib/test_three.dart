...
class SimpleCircularProgress extends StatefulWidget {
  const SimpleCircularProgress({Key? key}) : super(key: key);

  @override
  State<SimpleCircularProgress> createState() => _SimpleCircularProgressState();
}

class _SimpleCircularProgressState extends State<SimpleCircularProgress> {
  @override
  void initState() {
    super.initState();
  }
