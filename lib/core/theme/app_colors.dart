...
class AppColors {
  ...
  static const Color brandBackground = Color(0xFF003A46); // خلفية رئيسية
  static const Color brandBackgroundAlt = Color(0xFF003A45);
  static const Color brandMint = Color(0xFF83BEA8); // لون الأزرار الأساسي
  static const Color translucentFieldFill = Color(0x30FFFFFF); // ~19% أبيض
  static const Color hintOnDark = Color(0x91FFFFFF); // ~57% أبيض

  // Light Color Scheme
  static const ColorScheme lightColorScheme = ColorScheme(
    brightness: Brightness.dark, // نستخدم ألوان داكنة مع خلفية غامقة
    // Primary Colors
    primary: brandMint,
    onPrimary: Color(0xFFFFFFFF),
    primaryContainer: Color(0xFF5BAE96),
    onPrimaryContainer: Color(0xFFFFFFFF),

    // Secondary Colors
    secondary: Color(0xFF80BBA6),
    onSecondary: Color(0xFF0E1A18),
    secondaryContainer: Color(0xFF4F8E7B),
    onSecondaryContainer: Color(0xFFFFFFFF),

    // Tertiary Colors
    tertiary: Color(0xFF69AFA1),
    onTertiary: Color(0xFF0E1A18),
    tertiaryContainer: Color(0xFF3E7469),
    ...
    // Surface & Background
    surface: brandBackground, // سطح وخلفية باللون الغامق
  ...
  static Color get surfaceVariant => lightColorScheme.surfaceContainerHighest;
  static Color get onSurfaceVariant => lightColorScheme.onSurfaceVariant;

  static Color get background => lightColorScheme.surface;
  static Color get onBackground => lightColorScheme.onSurface;
