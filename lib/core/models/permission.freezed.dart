...
class _$PermissionImpl implements _Permission {
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, guardName, createdAt, updatedAt);
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(id, name, guardName, createdAt, updatedAt);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(id, name, guardName, createdAt, updatedAt);
  }
...
abstract class _Permission implements Permission {
  const factory _Permission(
      ...
      @JsonKey(name: "updated_at") final String? updatedAt}) = _$PermissionImpl;
