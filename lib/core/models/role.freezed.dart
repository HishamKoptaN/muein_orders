...
class _$RoleImpl implements _Role {
  const _$RoleImpl(
      ...
      @JsonKey(name: "permissions") final List<Permission>? permissions,
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, guardName,
      const DeepCollectionEquality().hash(_permissions), createdAt, updatedAt);
